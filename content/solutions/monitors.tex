...
\\
Es wurde von den Betreuern vorgegeben, dass für sämtliche Verbindungen zum Server HTTPS verwendet werden sollte (siehe \gref{sec:content_tech_https}). Dies führt bei der Registrierung der Monitore zu Problemen (siehe folgendes).
