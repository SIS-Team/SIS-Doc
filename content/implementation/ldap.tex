...
\lstinputlisting[style=custom, language=php, caption={/modules/general/LDAP.php; \texttt{getClass()}; Zeilen 129-141}, label={lst:content_imple_ldap_getdn}, firstline=129, lastline=141, firstnumber=129]{sources/ldap/LDAP.php}
...
\lstinputlisting[style=custom, language=php, caption={/modules/general/LDAP.php; \texttt{LDAP\_login()}; Zeilen 17-29}, label={lst:content_imple_ldap_getdn}, firstline=17, lastline=29, firstnumber=17]{sources/ldap/LDAP.php}
