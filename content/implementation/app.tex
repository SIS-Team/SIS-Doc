...
\lstinputlisting[style=custom, language=html, caption={/mobile/api/timetables.php; Veränder des Tabelleninhaltes; Zeile 105}, label={lst:widget}, firstline=105, lastline=105, firstnumber=105]{sources/app/api/timetables.php}	
