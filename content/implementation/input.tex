...
\lstinputlisting[style=custom, language=php, caption={Array Field}, label={lst:content_imple_input}, firstline =40, lastline = 64, firstnumber = 40 ]{sources/input/teacher.php}