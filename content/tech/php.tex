...
\begin{lstlisting}[style=customPHP, caption={PHP-Tags},label={lst:content_php_Tags}]
<?php 
	/* Programm-Code */
?>
\end{lstlisting}
...
\begin{lstlisting}[style=customPHP, caption={Session},label={lst:content_php_Session}]
<?php
	session_start();
?>
\end{lstlisting}
...
\begin{lstlisting}[style=CustomPHP, caption={Ausschnitt HTTP-Body},label={lst:content_php_HTTP_POST}]
...
\end{lstlisting}
\begin{lstlisting}[style=CustomPHP, caption={Beispiel POST},label={lst:content_php_POST}]
<html>
<header>
</header>
<body>
...
\begin{lstlisting}[style=CustomPHP, caption={Beispiel GET},label={lst:content_php_GET}]
<html>
<header>
</header>
<body>
...
\begin{lstlisting}[style=customPHP, caption={false},label={lst:content_php_false}]
<?php 
	$string = "Hallo Welt";
